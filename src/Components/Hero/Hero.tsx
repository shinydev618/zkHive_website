    ...
    >
      ...
      <div className=' container px-5 lg:px-0 relative pt-[102px]'>
        <div className='w-full'>
          <h1 className='text-[28px] lg:text-[71px] text-white font-bold leading-[30px] lg:leading-[85.2px] text-left title'>
            AI Powered decentralized
          </h1>
          <h1 className='text-[28px] lg:text-[71px] font-bold text-white leading-[30px] lg:leading-[85.2px] text-right title'>
        ...
        <div className='flex relative items-center  pb-[300px] lg:pb-[179px]  justify-between flex-col lg:flex-row'>
          <div className='z-[10] relative w-full lg:w-1/2 -translate-y-[0px] flex items-center '>
            <div className='flex pl-[35px] pt-10 lg:pt-0 lg:pl-0 translate-y-0 gap-y-[100px] lg:translate-y-[-100px] flex-col lg:gap-y-[50px]'>
              {SOCIAL_LINKS.map((icon, index) => (
                <button
                  key={index}
                  className={`w-[25px] h-[25px]  xl:w-[93px] xl:h-[93px] text-black flex justify-center items-center z-[100]`}
          ...
          <div className='w-full lg:w-1/2 pt-[85px]'>
            ...
            <div className='flex flex-col justify-center gap-y-[30px] lg:flex-row gap-x-[30px] mt-[50px]'>
              <button
                className={` ${styles.hero_button}  text-2xl lg:text-base cursor-pointer px-[36px] py-[34px] lg:py-[11px] flex items-center gap-x-2.5 text-black min-w-[185px]`}
              ...
              <button
                className={`${styles.hero_button} min-w-[185px]  text-2xl lg:text-base text-black cursor-pointer px-[33px] py-[34px] lg:py-[11px] flex items-center gap-x-2.5 `}
